...
export async function POST(request) {
  try {
    ...
    const result = await proxyRedisRequest("/redis/set", payload, "Falha ao gravar chave no Redis.");
...
function validateSetPayload(payload) {
  ...
  if (typeof payload.value !== "string") throw new Error("Informe value como string.");
}
